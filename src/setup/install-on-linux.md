...
Run the command `rustc --version`, which prints the version of the currently installed Rust compiler. If everything went well, the output should look similar to this:
