...
In the [Tuples](tuples.md) chapter, we looked at special syntax for "breaking down" a tuple object into its elements.
...
```rust
let arr: [i32;5] = [1, 2, 3, 4, 5];
let [a1, _, a3, rest @ ..] = arr;
// The type of `rest` variable - array [i32, 2]
println!("a1={}, a3={}, rest={:?}", a1, a3, rest);
```
