...
Be careful: there should be <ins>no</ins> semicolon after the last expression in the scope, if you want the result of this expression to become a result of the whole scope.
